...
public class GpsTrackeNew extends Service implements LocationListener {
    ...
    public GpsTrackeNew(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(GpsTrackeNew.this);
        }
    }
