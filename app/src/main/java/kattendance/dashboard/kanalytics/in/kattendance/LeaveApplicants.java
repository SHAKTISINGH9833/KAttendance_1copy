...
public class LeaveApplicants extends AppCompatActivity {
  ...
  private static final String LEAVE_APPLICANTS_LIST = "https://dashboard.kanalytics.in/mobile_app/attendance/leave_applicants_list.php";
  ...
  private void getValueFromJson(final String user_id) {
    ...
    StringRequest strReq = new StringRequest(Request.Method.POST,
      LEAVE_APPLICANTS_LIST, new Response.Listener<String>() {
      @Override
 ...
 /* @Override
  public void onBackPressed() {
    super.onBackPressed();
    Intent moveToNextAcitivty=new Intent(LeaveApplicants.this,MainActivity.class);
